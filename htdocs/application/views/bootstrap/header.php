...
$menu_items = array(
  'index' => array(
    'label' => 'Home',
    'desc' => 'A list of all my grantschools',
  ),
  'add' => array(
    'label' => 'Add',
    'desc' => 'Add a grantschool to my collection',
  ),
);
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ESE Grant Schools | <?php html_escape($menu_items[$menu_current]['label']); ?></title>
    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <a class="brand" href="http://localhost:8888/index.php/grantschool/index">ESE Networks Georgia Grant Schools</a>
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                          <?php
                            foreach ($menu_items as $item => $item_data) {
                              echo '<li' . ($item == $menu_current ? ' class="active"' : '') . '>';
                              echo '<a href="/index.php/grantschool/' . $item . '" title="' . $item_data['desc'] . '">' . $item_data['label'] . '</a>';
                              echo '</li>';
                            }
                          ?>
                        </ul>
